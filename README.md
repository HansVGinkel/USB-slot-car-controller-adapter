...
- **Two potentiometers 10k Ohm with knobs** to calibrate the input range between brake and full throthle. Two 5k Ohm potentiometers can be used as alternative.
